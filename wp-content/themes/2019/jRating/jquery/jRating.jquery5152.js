...
(function ($) {
    ...
    $.fn.jRating = function (op) {
        var defaults = {
            /** String vars **/
            bigStarsPath: '' + all_vars.templateUrl + '/jRating/jquery/icons/stars.png', // path of the icon stars.png
            smallStarsPath: '' + all_vars.templateUrl + '/jRating/jquery/icons/small.png', // path of the icon small.png
                ...
                if (!jDisabled)
                    $(this).unbind().bind({
                        ...
                        mousemove: function (e) {
                            ...
                            $(this).nextAll("span.Ratingnumber:first").css('display', 'inline-block').html(getNote(newWidth) + ' <span class="maxRate">/ ' + opts.rateMax + '</span>');
